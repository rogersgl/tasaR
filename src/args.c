...
#define _POSIX_C_SOURCE 200809L // -added during tasaR because above line was blocking snprintf during R compilation on Macos
#include "config.h"
#include <ctype.h>
#include <errno.h>
#include <stdlib.h>
#include <string.h>
#include <stdio.h> // -added during tasaR
